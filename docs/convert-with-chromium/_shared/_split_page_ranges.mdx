...
Happens _during_ conversion — faster, as unused pages are never rendered.

:::info Page Breaks

Unlike word processors, HTML has no intrinsic concept of "pages" until it is printed. Use CSS fragmentation properties to control breaks:
