...
**Chromium uses the print media type.**
By default, browsers optimize pages for printing by removing background colors/images and adjusting the layout to save ink.
