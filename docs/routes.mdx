...
| embedded         | Whether this file should be embedded in the PDF (see [Embedded Files](#embedded-files)).        | false                                             |
...
The following *multipart/form-data* endpoints accept the `embeds` form field to attach files to the generated PDF:
