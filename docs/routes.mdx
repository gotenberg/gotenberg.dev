...
```json
{
    ...
    "modules_additional_data": {
        "chromium": {
            "version": "Chromium 132.0.6834.159 built on Debian GNU/Linux 12 (bookworm)"
        },
        "exiftool": {
            "version": "12.57"
        },
        "libreoffice-api": {
            "version": "LibreOffice 24.8.4.2 480(Build:2)"
        },
        "pdfcpu": {
            "version": "v0.8.1 dev"
        },
        "pdftk": {
            "version": "pdftk port to java 3.3.3 a Handy Tool for Manipulating PDF Documents"
        },
        "qpdf": {
