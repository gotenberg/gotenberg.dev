...
| exportFormFields | Set whether to export the form fields or to use the inputted/selected content of the fields. | true      |
| singlePageSheets | Set whether to render the entire spreadsheet as a single page.                               | false     |
...
For instance, the live demo prints `8.5.0-live-demo-snapshot`.
