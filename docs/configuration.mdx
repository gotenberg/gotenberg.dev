...
| <span class="badge badge--secondary">--api-enable-basic-auth</span>            | Enable basic authentication - will look for the GOTENBERG_API_BASIC_AUTH_USERNAME and GOTENBERG_API_BASIC_AUTH_PASSWORD environment variables. | false           |                                                                          | false           |
...
| Engine                                       | Merge | Convert into PDF/A | Read/Write metadata | Name                  |
|----------------------------------------------|-------|--------------------|---------------------|-----------------------|
