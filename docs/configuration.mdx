...
Alternatively, you can set environment variables that directly correspond to the command-line flags. For example "--chromium-incognito" to "CHROMIUM_INCOGNITO".
