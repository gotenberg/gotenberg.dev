...
- **Updates:** Consider upgrading to the latest Gotenberg version to benefit from debugging features like [Network Errors](routes#network-errors-chromium) or [Invalid HTTP Status Codes](routes#invalid-http-status-codes-chromium).
