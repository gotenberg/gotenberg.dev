...
If `--unoconv-disable-listener` is set to true, Gotenberg starts a dedicated LibreOffice instance for each conversion.
It also impacts the performance of the [unoconv](pdf-engines#unoconv) PDF engine.
