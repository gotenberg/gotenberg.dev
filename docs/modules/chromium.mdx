...
The [health route](api#health) returns a `503 Service Unvailable` response if the failed starts
...
See issue [#521](https://github.com/gotenberg/gotenberg/issues/521) for more details.
