...
The `details` section gathers the health checks from modules. If none, this entry is not present.

The following modules provide health checks:

* [Chromium](chromium#health-check)
