...
Use the `autoIndexBookmarks` form field to automatically extract existing bookmarks from input files and offset their page numbers based on their position in the merged document.
