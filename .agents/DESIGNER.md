...
You are modifying the visual design, React components, styles, or layout of the Gotenberg documentation website.
...
3. No visual regressions on the homepage, documentation pages, and sidebar
4. Components render correctly at desktop (1440px), laptop (1024px), and tablet (768px) widths
5. No console errors or React warnings in the browser
